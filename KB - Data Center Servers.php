        ...
        <div class="dc-servers-wrap">
            ...
            <div class="dc-import-export">
                ...
                <div class="dc-import-export-row">
                    ...
                    <?php
                    $export_nonce = wp_create_nonce( 'dc_servers_export' );
                    $csv_url      = esc_url( add_query_arg( array( 'dc_servers_export' => 'csv', '_wpnonce' => $export_nonce ) ) );
                    $excel_url    = esc_url( add_query_arg( array( 'dc_servers_export' => 'excel', '_wpnonce' => $export_nonce ) ) );
                    ?>
                    <a class="dc-btn-secondary" href="<?php echo $csv_url; ?>">ייצוא CSV</a>
                    <a class="dc-btn-secondary" href="<?php echo $excel_url; ?>">ייצוא Excel</a>
                </div>
            </div>
        </div>
        <?php
